...
class TrainerAgent(BaseAgent):
    def __init__(self, cfg, memory=None, logger=None, master=None, pupil=None):
        ...
        self.finetuner = PupilFineTuner(
            input_dim=1028,  # match embedding dim of pupil
            output_dim=1028  # match embedding dim of master
        )

    def align_response(self, question, epochs=3):
        master_answer = self.master.answer(question)
        pupil_answer = self.pupil.answer(question)
