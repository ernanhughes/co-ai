...
class ScoringEngine:
    ...
    def score(self, target_id, target_type: TargetType, text: str, context: dict, scoring_profile: str) -> ScoreBundle:
        try:
    ...
    def score_item(self, scorable: Scorable, context: dict, scoring_profile: str) -> ScoreBundle:
        try:
            scoring_manager = self.get_manager(scoring_profile)
            ...
            self.logger.log("ScoreItemFailed", {
